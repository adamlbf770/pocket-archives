...
demoInventory.push(
  ...
  },
  {
    ...
    images: [ownedPhoto("/shop/inventory/pa-0038-front.jpg", "Dark Primeape Team Rocket 43/82 1st Edition — scanned front", "front"), ownedPhoto("/shop/inventory/pa-0038-back.jpg", "Dark Primeape Team Rocket 43/82 1st Edition — scanned reverse", "back")], sourceMetadata: "Original front and reverse images extracted from the submitted six-page scanner PDF, pages three and four.", rightsMetadata: "Original Pocket Archives inventory scan.", featured: true, demo: false,
  },
  {
