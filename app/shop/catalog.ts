...
demoInventory.push(
  ...
  },
  {
    ...
    images: [ownedPhoto("/shop/inventory/pa-0026-front.jpg", "Treecko EX Ruby & Sapphire 75/109 — scanned front", "front"), ownedPhoto("/shop/inventory/pa-0026-back.jpg?v=corrected", "Treecko EX Ruby & Sapphire 75/109 — scanned reverse", "back")], sourceMetadata: "Original front rescan and reverse Pocket Archives scanner image from batch 03, position three.", rightsMetadata: "Original Pocket Archives inventory scan.", featured: true, demo: false,
  },
  {
  ...
  },
  {
    ...
    year: 1999, approximateYear: false, era: "Neo era · 1999", country: "Japan", language: "Japanese", artist: "Ken Sugimori", illustrator: "Ken Sugimori", manufacturer: null, publisher: null, set: "Neo Premium File 1", series: "Neo", cardNumber: "No.159", catalogNumber: "PA-0028", edition: null, printing: "Japanese · Old back · Normal", condition: "Heavily Played", conditionNotes: "Heavy reverse-edge whitening and corner wear with widespread scratches, scuffs, and handling marks. The front has additional edge and surface wear. No crease is clearly confirmed by the flatbed scans.", dimensions: "Approx. 63 × 88 mm", provenance: "Owned and scanned by Pocket Archives; separated from nine-card batch 04 on 2026-08-16.", acquisitionSource: "Pocket Archives founder collection", acquisitionDate: "2026-08-16",
    ...
    images: [ownedPhoto("/shop/inventory/pa-0028-front.jpg", "Croconaw Neo Premium File 1 No.159 — scanned front", "front"), ownedPhoto("/shop/inventory/pa-0028-back.jpg", "Croconaw Neo Premium File 1 No.159 — scanned reverse", "back")], sourceMetadata: "Original front and reverse Pocket Archives scanner images from batch 04, row one column one.", rightsMetadata: "Original Pocket Archives inventory scan.", featured: true, demo: false,
  },
  {
    ...
    year: 2001, approximateYear: false, era: "Wizards era · 2001", country: "United States", language: "English", artist: "Naoyo Kimura", illustrator: "Naoyo Kimura", manufacturer: "Wizards of the Coast", publisher: "Wizards of the Coast", set: "Southern Islands", series: "Southern Islands", cardNumber: "10/18", catalogNumber: "PA-0029", edition: null, printing: "English · Normal", condition: "Heavily Played", conditionNotes: "Heavy whitening along the reverse edges and corners, with surface scratches, scuffs, small edge nicks, and front handling wear. No crease is clearly confirmed by the flatbed scans.", dimensions: "Approx. 63.5 × 88 mm", provenance: "Owned and scanned by Pocket Archives; separated from nine-card batch 04 on 2026-08-16.", acquisitionSource: "Pocket Archives founder collection", acquisitionDate: "2026-08-16",
    pokemonIds: [73], pokemonNames: ["Tentacruel"], artistIds: ["naoyo-kimura"], relatedMuseumIds: [], relatedArchiveIds: [], relatedCardIds: [], relatedCollectionIds: [], tags: ["Live Inventory", "Southern Islands", "Promo", "Vintage", "Singles", "Cards"], fromArchive: false, physicalOwnership: true, commerceMode: "fixedPrice", recordState: "available", availabilityStatus: "available", price: 21.99, currency: "USD", quantity: 1, reserved: false, soldDate: null, placedInPrivateCollection: false,
    images: [ownedPhoto("/shop/inventory/pa-0029-front.jpg", "Tentacruel Southern Islands 10/18 — scanned front", "front"), ownedPhoto("/shop/inventory/pa-0029-back.jpg", "Tentacruel Southern Islands 10/18 — scanned reverse", "back")], sourceMetadata: "Original front and reverse Pocket Archives scanner images from batch 04, row one column two.", rightsMetadata: "Original Pocket Archives inventory scan.", featured: true, demo: false,
  },
  {
    ...
    year: 1999, approximateYear: false, era: "Neo era · 1999", country: "Japan", language: "Japanese", artist: "Ken Sugimori", illustrator: "Ken Sugimori", manufacturer: null, publisher: null, set: "Neo Premium File 1", series: "Neo", cardNumber: "No.158", catalogNumber: "PA-0030", edition: null, printing: "Japanese · Old back · Normal", condition: "Heavily Played", conditionNotes: "Heavy reverse-edge and corner whitening with scratches, scuffs, and small nicks. The front shows scattered surface marks and edge wear. No crease is clearly confirmed by the flatbed scans.", dimensions: "Approx. 63 × 88 mm", provenance: "Owned and scanned by Pocket Archives; separated from nine-card batch 04 on 2026-08-16.", acquisitionSource: "Pocket Archives founder collection", acquisitionDate: "2026-08-16",
    ...
    images: [ownedPhoto("/shop/inventory/pa-0030-front.jpg", "Totodile Neo Premium File 1 No.158 — scanned front", "front"), ownedPhoto("/shop/inventory/pa-0030-back.jpg", "Totodile Neo Premium File 1 No.158 — scanned reverse", "back")], sourceMetadata: "Original front and reverse Pocket Archives scanner images from batch 04, row one column three.", rightsMetadata: "Original Pocket Archives inventory scan.", featured: true, demo: false,
  },
  {
    ...
    year: 1996, approximateYear: false, era: "Launch era · 1996", country: "Japan", language: "Japanese", artist: "Keiji Kinebuchi", illustrator: "Keiji Kinebuchi", manufacturer: null, publisher: null, set: "Expansion Pack (Japanese Base Set)", series: "Original Japanese series", cardNumber: "No.082", catalogNumber: "PA-0031", edition: null, printing: "Japanese · Old back · Holofoil", condition: "Heavily Played", conditionNotes: "Numerous scratches cross the holographic artwork, with heavy reverse-edge whitening, corner wear, scuffs, and handling marks. No crease is clearly confirmed by the flatbed scans.", dimensions: "Approx. 63 × 88 mm", provenance: "Owned and scanned by Pocket Archives; separated from nine-card batch 04 on 2026-08-16.", acquisitionSource: "Pocket Archives founder collection", acquisitionDate: "2026-08-16",
    pokemonIds: [82], pokemonNames: ["Magneton"], artistIds: ["keiji-kinebuchi"], relatedMuseumIds: [], relatedArchiveIds: [], relatedCardIds: [], relatedCollectionIds: [], tags: ["Live Inventory", "Japanese Base Set", "Holo Rare", "Japanese", "Vintage", "Singles", "Cards"], fromArchive: false, physicalOwnership: true, commerceMode: "fixedPrice", recordState: "available", availabilityStatus: "available", price: 7.99, currency: "USD", quantity: 1, reserved: false, soldDate: null, placedInPrivateCollection: false,
    images: [ownedPhoto("/shop/inventory/pa-0031-front.jpg", "Magneton Japanese Base Set No.082 holo — scanned front", "front"), ownedPhoto("/shop/inventory/pa-0031-back.jpg", "Magneton Japanese Base Set No.082 holo — scanned reverse", "back")], sourceMetadata: "Original front and reverse Pocket Archives scanner images from batch 04, row two column one.", rightsMetadata: "Original Pocket Archives inventory scan.", featured: true, demo: false,
  },
  {
    ...
    year: 2000, approximateYear: false, era: "Neo era · 2000", country: "Japan", language: "Japanese", artist: "Toshinao Aoki", illustrator: "Toshinao Aoki", manufacturer: null, publisher: null, set: "Awakening Legends", series: "Neo", cardNumber: "No.181", catalogNumber: "PA-0032", edition: null, printing: "Japanese · Old back · Holofoil", condition: "Heavily Played", conditionNotes: "Visible scratches across the holographic artwork with heavy reverse-edge whitening, corner wear, scuffs, and handling marks. No crease is clearly confirmed by the flatbed scans.", dimensions: "Approx. 63 × 88 mm", provenance: "Owned and scanned by Pocket Archives; separated from nine-card batch 04 on 2026-08-16.", acquisitionSource: "Pocket Archives founder collection", acquisitionDate: "2026-08-16",
  ...
  },
  {
    ...
    images: [ownedPhoto("/shop/inventory/pa-0034-front.jpg", "Kangaskhan Jungle 21/64 Unlimited — scanned front", "front"), ownedPhoto("/shop/inventory/pa-0034-back.jpg", "Kangaskhan Jungle 21/64 Unlimited — scanned reverse", "back")], sourceMetadata: "Original front and reverse Pocket Archives scanner images from batch 04, row three column one.", rightsMetadata: "Original Pocket Archives inventory scan.", featured: true, demo: false,
  },
  {
    ...
    year: 2000, approximateYear: false, era: "Neo era · 2000", country: "Japan", language: "Japanese", artist: "Kagemaru Himeno", illustrator: "Kagemaru Himeno", manufacturer: null, publisher: null, set: "Gold, Silver, to a New World…", series: "Neo", cardNumber: "No.173", catalogNumber: "PA-0035", edition: null, printing: "Japanese · Old back · Normal", condition: "Heavily Played", conditionNotes: "Heavy reverse-edge whitening and corner wear with scratches, scuffs, and small nicks. The front has scattered surface marks and edge wear. No crease is clearly confirmed by the flatbed scans.", dimensions: "Approx. 63 × 88 mm", provenance: "Owned and scanned by Pocket Archives; separated from nine-card batch 04 on 2026-08-16.", acquisitionSource: "Pocket Archives founder collection", acquisitionDate: "2026-08-16",
    ...
    images: [ownedPhoto("/shop/inventory/pa-0035-front.jpg", "Cleffa Gold, Silver, to a New World No.173 — scanned front", "front"), ownedPhoto("/shop/inventory/pa-0035-back.jpg", "Cleffa Gold, Silver, to a New World No.173 — scanned reverse", "back")], sourceMetadata: "Original front and reverse Pocket Archives scanner images from batch 04, row three column two.", rightsMetadata: "Original Pocket Archives inventory scan.", featured: true, demo: false,
  },
  {
