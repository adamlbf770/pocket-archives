...
demoInventory.push(
  ...
  },
  {
    ...
    images: [ownedPhoto("/shop/inventory/ebay-import/pa-0017-front.webp", "Doublade 098/088 — photographed front", "front"), ownedPhoto("/shop/inventory/ebay-import/pa-0017-back.webp", "Doublade 098/088 — photographed reverse", "back")], sourceMetadata: "Imported from the active Pocket_Archives eBay listing on 2026-08-15; Pocket Archives price is $1 below the $2.49 eBay price after the 2026-08-28 market review.", rightsMetadata: "Pocket_Archives inventory photography.", featured: true, demo: false,
  },
  {
...
demoInventory.push({
  accessionNumber: "PA-0041",
  id: "LIVE-030",
  slug: "pokemon-pocket-monsters-volume-7-anakubo-1999",
  title: "Pokémon Pocket Monsters, Vol. 7",
  subtitle: "1999 Japanese manga · Kosaku Anakubo",
  objectType: "Manga volume",
  category: "Printed Matter",
  description: "An original Japanese copy of Pokémon Pocket Monsters volume 7, written and drawn by Kosaku Anakubo and published by Shogakukan in 1999. The exact pre-owned copy is shown across four photographs, including its front cover, reverse, and interior pages.",
  archivalNote: "Kosaku Anakubo was already an established gag-manga artist when CoroCoro selected him to create a Pokémon comic as the original games launched in 1996. In a later interview, Anakubo recalled beginning with only a small packet of character references and little of the franchise language that would soon become familiar. His editor favored Clefairy as the comic partner while Anakubo preferred Pikachu; that choice produced the loud, mischievous Clefairy and irreverent visual comedy that made this series distinct from the games, anime, and later adventure manga.",
  culturalSignificance: "This is volume 7 of the first long-running Pokémon manga series, released on July 28, 1999—months before Pokémon Gold and Silver opened the Johto era. Its cast and slapstick style preserve a moment when Pokémon had already become a global phenomenon but its printed identity was still unusually flexible. Rather than treating the characters as fixed brand models, Anakubo exaggerated their faces, bodies, and behavior for comedy, recording an important parallel history of early Pokémon art.",
  year: 1999,
  approximateYear: false,
  era: "First-generation boom · 1996–1999",
  country: "Japan",
  language: "Japanese",
  artist: "Kosaku Anakubo",
  illustrator: "Kosaku Anakubo",
  manufacturer: null,
  publisher: "Shogakukan",
  set: "Tentōmushi CoroCoro Comics",
  series: "Pokémon Pocket Monsters",
  cardNumber: null,
  catalogNumber: "ISBN 978-4-09-142517-1",
  edition: "Japanese collected edition",
  printing: "Tentōmushi Comics",
  condition: "Good",
  conditionNotes: "Pre-owned Japanese-language copy with visible edge and corner wear, light cover scuffing, handling marks, and minor surface wear. The photographed interior pages appear intact. Review all four photographs for the exact copy; no professional condition grade is claimed.",
  dimensions: "Approx. 18 cm tall",
  provenance: "Owned and photographed by Pocket Archives on August 26, 2026. The listing photographs show the exact copy offered for sale.",
  acquisitionSource: "Pocket Archives founder collection",
  acquisitionDate: "2026-08-26",
  pokemonIds: [25, 35, 54, 175],
  pokemonNames: ["Pikachu", "Clefairy", "Psyduck", "Togepi"],
  artistIds: ["kosaku-anakubo"],
  relatedMuseumIds: [],
  relatedArchiveIds: [],
  relatedCardIds: [],
  relatedCollectionIds: ["vintage-japanese-printed-matter"],
  tags: ["Live Inventory", "Manga", "Printed Matter", "Vintage Japanese", "Kosaku Anakubo", "CoroCoro", "First Generation"],
  fromArchive: false,
  physicalOwnership: true,
  commerceMode: "fixedPrice",
  recordState: "available",
  ...
  images: [
    {
      ...
      caption: "Pokémon Pocket Monsters volume 7 — photographed front cover",
      view: "front",
      creator: "Pocket Archives",
      rightsHolder: "Pocket Archives",
      rightsStatus: "allowed",
    ...
    {
      src: "/shop/inventory/pokemon-pocket-monsters-vol-7/back.jpg",
      caption: "Pokémon Pocket Monsters volume 7 — photographed back cover and ISBN",
      view: "back",
      creator: "Pocket Archives",
      rightsHolder: "Pocket Archives",
      rightsStatus: "allowed",
    ...
    {
      src: "/shop/inventory/pokemon-pocket-monsters-vol-7/interior-spread.jpg",
      caption: "Pokémon Pocket Monsters volume 7 — photographed interior artwork",
      view: "detail",
      creator: "Pocket Archives",
      rightsHolder: "Pocket Archives",
      rightsStatus: "allowed",
    ...
    {
      src: "/shop/inventory/pokemon-pocket-monsters-vol-7/interior-page.jpg",
      caption: "Pokémon Pocket Monsters volume 7 — photographed interior page",
      view: "detail",
      creator: "Pocket Archives",
      rightsHolder: "Pocket Archives",
      rightsStatus: "allowed",
  ...
  sourceMetadata: "Bibliographic and historical research checked against Shogakukan/CoroCoro's official series page, CoroCoro's Anakubo series listing, a 2017 interview with Kosaku Anakubo, and the volume's ISBN record (9784091425171).",
  rightsMetadata: "Original Pocket Archives photographs of the exact physical copy. Interior images are shown only to identify the edition, artwork, and condition.",
  featured: true,
  demo: false,
});

demoInventory.push({
  accessionNumber: "PA-0042",
  id: "LIVE-031",
  slug: "pokemon-classic-adventure-collection-scholastic-2021",
  title: "Pokémon Classic Adventure Collection",
  subtitle: "2021 Scholastic boxed set · 8 books, 16 stories",
  objectType: "Chapter-book boxed set",
  category: "Printed Matter",
  description: "A complete eight-volume Pokémon Classic Adventure Collection from Scholastic, gathering sixteen English-language stories adapted from the animated series. The photographed set includes all eight paperback books and the illustrated slipcase; six views show the box, spines, contents panel, reverse, and two individual covers.",
  archivalNote: "Scholastic helped translate Pokémon's television success into an everyday reading culture in North America. These compact chapter books retold anime episodes in prose with screen-derived illustrations, making the Orange Islands and early Johto story lines portable for school book fairs, classrooms, and young readers. The 2021 collection brings together stories first associated with the franchise's turn-of-the-millennium English publishing wave, including Journey to the Orange Islands, The Four-Star Challenge, Race to Danger, Psyduck Ducks Out, The Chikorita Challenge, Battle for the Zephyr Badge, and Secrets of the GS Ball.",
  culturalSignificance: "This boxed reissue preserves a specific form of Pokémon ephemera: inexpensive children's books that sat between television, licensed publishing, and collecting. Its sixteen stories trace the anime's transition from the Orange Islands into the Johto era, when the franchise was expanding beyond the original 151 and American audiences were learning a new generation of characters through television and print at the same time.",
  year: 2021,
  approximateYear: false,
  era: "Classic-anime retrospective · 2021",
  country: "United States",
  language: "English",
  artist: null,
  illustrator: null,
  ...
  set: "Classic Adventure Collection",
  series: "Pokémon chapter books",
  cardNumber: null,
  catalogNumber: "ISBN 978-1-338-76728-5",
  edition: "Eight-book boxed edition",
  printing: "English-language paperback set",
  condition: "Good",
  conditionNotes: "Complete set of eight paperback books with the illustrated slipcase. Visible shelf and handling wear includes rubbing, softened corners, edge wear, and creasing to the box and book covers. The slipcase advertises a Pokémon bookmark, but no loose bookmark is shown separately in the supplied photographs and it is not guaranteed as included. Review all six photographs for the exact set; no professional condition grade is claimed.",
  dimensions: "Approx. 7.5 in. tall",
  provenance: "Owned and photographed by Pocket Archives on August 27, 2026. The listing photographs show the exact boxed set offered for sale.",
  acquisitionSource: "Pocket Archives founder collection",
  acquisitionDate: "2026-08-27",
  pokemonIds: [25, 52, 23, 21, 131, 152],
  pokemonNames: ["Pikachu", "Meowth", "Ekans", "Spearow", "Lapras", "Chikorita"],
  artistIds: [],
  relatedMuseumIds: [],
  relatedArchiveIds: [],
  relatedCardIds: [],
  relatedCollectionIds: ["pokemon-printed-matter"],
  tags: ["Live Inventory", "Printed Matter", "Scholastic", "Boxed Set", "Anime", "Orange Islands", "Johto"],
  fromArchive: false,
  physicalOwnership: true,
  commerceMode: "fixedPrice",
  recordState: "available",
  ...
  images: [
    {
      ...
      caption: "Pokémon Classic Adventure Collection — photographed front of slipcase",
      view: "front",
      creator: "Pocket Archives",
      rightsHolder: "Pocket Archives",
      rightsStatus: "allowed",
    ...
    {
      src: "/shop/inventory/pokemon-classic-adventure-collection/spines.jpg",
      caption: "All eight Pokémon chapter books — photographed spines",
      view: "packaging",
      creator: "Pocket Archives",
      rightsHolder: "Pocket Archives",
      rightsStatus: "allowed",
    ...
    {
      src: "/shop/inventory/pokemon-classic-adventure-collection/contents.jpg",
      caption: "Slipcase side panel listing the sixteen included stories",
      view: "detail",
      creator: "Pocket Archives",
      rightsHolder: "Pocket Archives",
      rightsStatus: "allowed",
    ...
    {
      src: "/shop/inventory/pokemon-classic-adventure-collection/back.jpg",
      caption: "Pokémon Classic Adventure Collection — photographed reverse of slipcase",
      view: "back",
      creator: "Pocket Archives",
      rightsHolder: "Pocket Archives",
      rightsStatus: "allowed",
    ...
    {
      src: "/shop/inventory/pokemon-classic-adventure-collection/four-star-challenge.jpg",
      caption: "The Four-Star Challenge — one of the included chapter books",
      view: "detail",
      creator: "Pocket Archives",
      rightsHolder: "Pocket Archives",
      rightsStatus: "allowed",
    ...
    {
      src: "/shop/inventory/pokemon-classic-adventure-collection/race-to-danger.jpg",
      caption: "Race to Danger — one of the included chapter books",
      view: "detail",
      creator: "Pocket Archives",
      rightsHolder: "Pocket Archives",
      rightsStatus: "allowed",
  ...
  sourceMetadata: "Edition and ISBN checked against the Scholastic product record and ISBN 9781338767285. Current used-market comparables reviewed across eBay, Poshmark, Mercari, PangoBooks, and OfferUp on August 27, 2026.",
  rightsMetadata: "Original Pocket Archives photographs of the exact physical set. Licensed cover art appears only as part of the photographed inventory.",
  featured: true,
  demo: false,
});
...
export const EXTERNAL_SHOP_URL = "https://www.ebay.com/str/pocketarchives";
