...
export const carddassShopStock: InventoryItem[] = [
  ...
  {
    accessionNumber: "PA-4388",
    id: "LIVE-036",
    slug: "magneton-bandai-carddass-no-082-green-pa-4388",
    title: "Magneton",
    subtitle: "1996 Bandai Carddass Pocket Monsters · No.082 · Green Version",
    objectType: "Collectible card",
    category: "Carddass",
    description:
      "An original Japanese Bandai Carddass Pocket Monsters Magneton No.082 from the 1996 Green Version. This is the exact physical copy shown in the front and reverse scans.",
    archivalNote:
      "Bandai released its red and green Carddass series alongside Pokémon's earliest years in Japan, before the franchise became an international trading-card phenomenon.",
    culturalSignificance:
      "One of Pokémon's earliest licensed card issues, translating Ken Sugimori's game-era character art into a compact vending-machine collectible.",
    year: 1996,
    approximateYear: false,
    era: "Launch era · 1996",
    country: "Japan",
    ...
    publisher: "Bandai",
    set: "Bandai Carddass Pocket Monsters",
    series: "Red & Green Version",
    cardNumber: "No.082",
    catalogNumber: "PA-4388",
    edition: "Green Version",
    printing: "1996 Japanese vending issue",
    condition: "Near Mint",
    conditionNotes:
      "Near Mint per owner inspection. The scans show the exact physical copy, including its edges, corners, surface, and reverse. No professional grade is claimed.",
    dimensions: "Approximately 59 × 86 mm",
    provenance: "Pocket Archives inventory; scanned and cataloged from Pokémon Ultrarare Box 1.",
    acquisitionSource: "Pocket Archives collection",
    acquisitionDate: "2026-08",
    pokemonIds: [82],
    pokemonNames: ["Magneton"],
    artistIds: ["ken-sugimori"],
    relatedMuseumIds: [],
    relatedArchiveIds: ["carddass-action-1"],
    relatedCardIds: [],
    relatedCollectionIds: ["before-the-tcg", "carddass-first-generation"],
    tags: ["Live Inventory", "Bandai Carddass", "Green Version", "Japanese", "Vintage", "Original 151", "Carddass"],
    fromArchive: false,
    physicalOwnership: true,
    commerceMode: "fixedPrice",
    recordState: "available",
    ...
    placedInPrivateCollection: false,
    images: [
      ownedPhoto("/shop/inventory/carddass/pa-4388-front.jpg", "Magneton Bandai Carddass No.082 Green Version — front scan", "front"),
      ownedPhoto("/shop/inventory/carddass/pa-4388-back.jpg", "Magneton Bandai Carddass No.082 Green Version — reverse scan", "back"),
    ],
    sourceMetadata: "Original front and reverse scans by Pocket Archives.",
    rightsMetadata:
