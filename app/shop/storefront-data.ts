...
export const catalogItems: CatalogItem[] = [
  ...
  { id: "CAT-VIGOROTH-RS", title: "EX Ruby & Sapphire Vigoroth 47/109", objectType: "Trading card", set: "EX Ruby & Sapphire", catalogNumber: "47/109", year: 2003, artist: "Kagemaru Himeno" },
  { id: "CAT-DARK-PRIMEAPE-ROCKET", title: "Team Rocket Dark Primeape 43/82 1st Edition", objectType: "Trading card", set: "Team Rocket", catalogNumber: "43/82", year: 2000, artist: "Mitsuhiro Arita" },
  { id: "CAT-LIGHT-SUNFLORA-ND", title: "Neo Destiny Light Sunflora 72/105 1st Edition", objectType: "Trading card", set: "Neo Destiny", catalogNumber: "72/105", year: 2002, artist: "Toshinao Aoki" },
  { id: "CAT-WIGGLYTUFF-CARDDASS-GREEN", title: "Bandai Carddass Green Version Wigglytuff No.040", objectType: "Collectible card", set: "Bandai Carddass Pocket Monsters", catalogNumber: "No.040", year: 1996, artist: null },
...
export const physicalCopies: PhysicalCopy[] = [
  ...
  { id: "PA-COPY-000041", catalogItemId: "CAT-VIGOROTH-RS", publicObjectId: "LIVE-026", condition: object("LIVE-026").condition, acquisitionCost: null, acquisitionSource: "Pocket Archives founder collection", allocation: { mode: "single", referenceId: null }, presentation: "raw", imageIds: object("LIVE-026").images.map((image) => image.src), storageLocation: "Pocket Archives inventory", saleState: "available", ownedByPocketArchives: true, consigned: false, consignorId: null, agreementStatus: "not-applicable", commissionRate: null, minimumNet: null, reserve: null, insuranceValue: null, intakeDate: "2026-08-16", returnDate: null, payoutStatus: "not-applicable", demo: false },
  { id: "PA-COPY-000042", catalogItemId: "CAT-DARK-PRIMEAPE-ROCKET", publicObjectId: "LIVE-027", condition: object("LIVE-027").condition, acquisitionCost: null, acquisitionSource: "Pocket Archives founder collection", allocation: { mode: "single", referenceId: null }, presentation: "raw", imageIds: object("LIVE-027").images.map((image) => image.src), storageLocation: "Pocket Archives inventory", saleState: "available", ownedByPocketArchives: true, consigned: false, consignorId: null, agreementStatus: "not-applicable", commissionRate: null, minimumNet: null, reserve: null, insuranceValue: null, intakeDate: "2026-08-16", returnDate: null, payoutStatus: "not-applicable", demo: false },
  { id: "PA-COPY-000043", catalogItemId: "CAT-LIGHT-SUNFLORA-ND", publicObjectId: "LIVE-028", condition: object("LIVE-028").condition, acquisitionCost: null, acquisitionSource: "Pocket Archives founder collection", allocation: { mode: "single", referenceId: null }, presentation: "raw", imageIds: object("LIVE-028").images.map((image) => image.src), storageLocation: "Pocket Archives inventory", saleState: "available", ownedByPocketArchives: true, consigned: false, consignorId: null, agreementStatus: "not-applicable", commissionRate: null, minimumNet: null, reserve: null, insuranceValue: null, intakeDate: "2026-08-16", returnDate: null, payoutStatus: "not-applicable", demo: false },
  { id: "PA-COPY-000044", catalogItemId: "CAT-WIGGLYTUFF-CARDDASS-GREEN", publicObjectId: "LIVE-029", condition: object("LIVE-029").condition, acquisitionCost: null, acquisitionSource: "Pocket Archives founder collection", allocation: { mode: "single", referenceId: null }, presentation: "raw", imageIds: object("LIVE-029").images.map((image) => image.src), storageLocation: "Pocket Archives inventory", saleState: "available", ownedByPocketArchives: true, consigned: false, consignorId: null, agreementStatus: "not-applicable", commissionRate: null, minimumNet: null, reserve: null, insuranceValue: null, intakeDate: "2026-08-16", returnDate: null, payoutStatus: "not-applicable", demo: false },
  { id: "PA-COPY-000046", catalogItemId: "CAT-POKEMON-CLASSIC-ADVENTURE", publicObjectId: "LIVE-031", condition: object("LIVE-031").condition, acquisitionCost: null, acquisitionSource: "Pocket Archives founder collection", allocation: { mode: "single", referenceId: "PA-0042" }, presentation: "raw", imageIds: object("LIVE-031").images.map((image) => image.src), storageLocation: "Pocket Archives inventory", saleState: "available", ownedByPocketArchives: true, consigned: false, consignorId: null, agreementStatus: "not-applicable", commissionRate: null, minimumNet: null, reserve: null, insuranceValue: null, intakeDate: "2026-08-27", returnDate: null, payoutStatus: "not-applicable", demo: false },
...
export const galleryObjectIds = ["LIVE-029", "LIVE-028", "LIVE-027", "LIVE-026", "LIVE-025", "LIVE-024", "LIVE-023", "LIVE-022", "LIVE-021", "LIVE-020", "LIVE-019", "LIVE-018", "LIVE-017", "LIVE-016", "LIVE-015", "LIVE-014", "LIVE-013", "LIVE-012", "LIVE-011", "LIVE-010", "LIVE-009", "LIVE-008", "LIVE-007", "LIVE-006", "LIVE-005", "LIVE-004", "LIVE-002", "LIVE-003", "LIVE-001", "DEMO-004", "DEMO-005", "DEMO-006", "DEMO-002"];
export const binderObjectIds = ["LIVE-029", "LIVE-028", "LIVE-027", "LIVE-026", "LIVE-025", "LIVE-024", "LIVE-023", "LIVE-022", "LIVE-021", "LIVE-020", "LIVE-019", "LIVE-018", "LIVE-017", "LIVE-016", "LIVE-015", "LIVE-014", "LIVE-013", "LIVE-012", "LIVE-011", "LIVE-010", "LIVE-009", "LIVE-008", "LIVE-007", "LIVE-006", "LIVE-005", "LIVE-004", "LIVE-002", "LIVE-003", "LIVE-001", "DEMO-001", "DEMO-003", "DEMO-008", "DEMO-009", "DEMO-010", "DEMO-011"];
