...
export const demoSales: AuctionSale[] = [
  {
    ...
    subtitle: "Selected objects from Pokémon’s foundational visual era.",
    ...
    curatorNote: "These demonstration lots show the intended structure of a Pocket Archives sale. No physical objects or real bids are represented.",
