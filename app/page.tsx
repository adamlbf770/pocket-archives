  ...
  return (
    <main>
      ...
      <section className="collection" id="collection">
        <div className="section-heading"><div><p className="eyebrow"><span /> {view === "favorites" ? "Your collection" : view === "museum" ? "Pocket Archives Museum" : "Explore the archive"}</p><h2>{view === "favorites" ? "Saved for later." : view === "museum" ? "Walk through history." : "See how they’re made."}</h2></div><p>{view === "favorites" ? "Every archive record you have favorited on this device, gathered in one place." : view === "museum" ? "A guided history of Pokémon—from a handmade arcade zine and six-year Game Boy experiment to a thirty-year global culture." : "From 1990 prototype concepts to modern production sheets—organized from oldest to newest and viewed without leaving the archive."}</p></div>
