...
export default function Home() {
  ...
  const [view, setView] = useState<"gallery" | "generations" | "designs" | "favorites">("gallery");
    ...
    <main>
      ...
      <section className="collection" id="collection">
        ...
        <div className="view-tabs" role="tablist" aria-label="Collection views">
          ...
          <button role="tab" aria-selected={view === "favorites"} className={view === "favorites" ? "active" : ""} onClick={() => { setView("favorites"); setFilter("all"); }}><span>04</span> Favorites <b>{favorites.size}</b></button>
        </div>
