...
import { inventoryForMuseum, inventoryForPokemon, shopObjectUrl } from "./shop/catalog";
...
type MuseumRoom = {
  id: string; year: string; title: string; subtitle: string; image: string; caption: string;
  body: string; highlights: string[]; source: string; sourceUrl: string;
};

type SpriteEra = {
  key: string; label: string; year: number; generation: number;
  sprites: Record<string, string>;
};

type SpriteEvolutionManifest = {
  source: { title: string; curator: string; community: string; driveUrl: string };
  eras: SpriteEra[];
};
...
const museumRooms: MuseumRoom[] = [
  { id: "roots", year: "1965–1989", title: "Before the monsters", subtitle: "Tajiri, Sugimori, and Game Freak", image: "/art/0658.webp", caption: "Rhydon · one of the earliest confirmed Pokémon designs", body: "Pokémon began with Satoshi Tajiri’s fascination with collecting living things and the culture of Japanese arcades. His handmade Game Freak strategy zine brought him together with illustrator Ken Sugimori; by 1989, Game Freak had become a development studio.", highlights: ["Tajiri explored fields and ponds in a still-rural Machida.", "Game Freak began as a self-published arcade fanzine, usually dated to 1983.", "The franchise grew from a team and a working culture—not a single isolated flash of inspiration."], source: "TIME · The History and Origins of Pokémon", sourceUrl: "https://time.com/6796536/history-origins-pokemon/" },
  { id: "capsule-monsters", year: "1990–1995", title: "Six years in development", subtitle: "Capsule Monsters and the link cable", image: "https://helixchamber.com/wp-content/uploads/2018/09/1990_Capsule_Monsters_00_map_reg.png", caption: "Capsule Monsters world study", body: "The first pitch was called Capsule Monsters. Tajiri imagined the Game Boy link cable as a way to transfer creatures between players. Trading came before much of the role-playing framework; Shigeru Miyamoto’s support and the paired-version idea turned social exchange into the game’s foundation.", highlights: ["Childhood collecting inspired discovery; the link cable inspired exchange.", "Ken Sugimori’s drawings made an abstract system feel like a lived-in world.", "Game Freak endured financial and technical strain during the unusually long production."], source: "Nintendo creator interviews · Capsule Monsters research archive", sourceUrl: "https://iwataasks.nintendo.com/interviews/ds/pokemon/0/0/" },
  { id: "red-green", year: "1996", title: "The breakthrough", subtitle: "Red, Green, and the mystery of Mew", image: "/art/0697.webp", caption: "Mew · the secret that helped Pokémon spread by word of mouth", body: "Pocket Monsters Red and Green launched in Japan on February 27, 1996. The first wave was not instant global mania. Mew—quietly left inside the game—became the catalyst when CoroCoro offered it to only 20 readers and tens of thousands applied.", highlights: ["Scarcity made Mew feel like a playground secret rather than ordinary content.", "Rumors and trading kept the games alive after release.", "Pokémon’s earliest success came from players explaining the mystery to one another."], source: "Nintendo · Iwata Asks: The Mythical Pokémon Mew", sourceUrl: "https://iwataasks.nintendo.com/interviews/ds/pokemon/0/0/" },
  { id: "media-mix", year: "1996–1997", title: "A world beyond the cartridge", subtitle: "Cards, animation, and a mascot", image: "/shop/cards/carddass-pikachu.jpg", caption: "Pikachu Carddass · physical collecting meets character storytelling", body: "The Trading Card Game arrived in Japan in October 1996 and the television anime in April 1997. Cards made collecting tangible; the anime made individual Pokémon emotionally legible. Pikachu’s partnership with Ash transformed one creature into a global symbol.", highlights: ["Japan’s order was games, then cards, then television.", "Each medium added something the Game Boy could not communicate alone.", "The 1997 flashing-light broadcast incident led to a hiatus and stricter animation safety practices."], source: "The Pokémon Company · Official history", sourceUrl: "https://corporate.pokemon.co.jp/en/aboutus/history/" },
  { id: "global-pokemania", year: "1998–2000", title: "Pokémania goes global", subtitle: "An anime-first international strategy", image: "/art/0571.webp", caption: "Pikachu · the emotional doorway to the international launch", body: "The American rollout deliberately reversed Japan’s sequence: television arrived before the games, followed by the cards. Children met the characters first, then entered the interactive worlds. Europe and other regions followed, each through its own mix of dubbing, imports, cards, toys, and official releases.", highlights: ["Red and Blue reached the United States in September 1998.", "The US Base Set followed in January 1999; Europe received the games later that year.", "Localization reshaped names, jokes, dialogue, cultural references, and sometimes images."], source: "The Pokémon Company · International business history", sourceUrl: "https://corporate.pokemon.co.jp/en/business/international" },
  { id: "lasting-system", year: "1999–2009", title: "More than a fad", subtitle: "Generations, regions, and institutions", image: "/shop/cards/squirtle-base.png", caption: "Base Set Squirtle · the game, card, and animation worlds reinforce one another", body: "Gold and Silver proved that Pokémon could renew itself without abandoning its ritual. New regions, breeding, time, online features, remakes, tournaments, and an increasingly organized company structure turned a craze into a durable cultural system.", highlights: ["Johto, Hoenn, and Sinnoh translated different parts of Japan into fantasy regions.", "Pokémon USA opened in 2001, London followed in 2003, and Pokémon Korea in 2006.", "Video-game and card competition converged at the World Championships in 2009."], source: "The Pokémon Company · Corporate history", sourceUrl: "https://corporate.pokemon.co.jp/en/aboutus/history/" },
  { id: "worldwide-design", year: "2010–2015", title: "Worldwide by design", subtitle: "Unova, 3D, and simultaneous discovery", image: "/art/1235.webp", caption: "Zekrom · Generation V moved the regional lens beyond Japan", body: "Black and White used New York as the basis for Unova and initially asked players to encounter only unfamiliar Pokémon. X and Y then moved the main series into modeled 3D and became the first core games released around the world at the same time.", highlights: ["The regions became a global cultural canvas rather than a map of Japan alone.", "Worldwide launch timing changed how news, strategy, fan art, and discovery spread.", "Pokémon kept the same collecting grammar while changing its geography and visual language."], source: "Nintendo developer interviews · The Pokémon Company history", sourceUrl: "https://iwataasks.nintendo.com/interviews/ds/pokemon-black-white/0/1/" },
  { id: "pokemon-go", year: "2016", title: "The world becomes the map", subtitle: "Pokémon GO and the second Pokémania", image: "/art/1425.webp", caption: "Rowlet · Generation VII arrived during Pokémon’s mobile breakthrough", body: "Pokémon GO returned the franchise to its earliest promise: walk outside, search for creatures, collect them, and meet other people doing the same thing. It reached $100 million in revenue in roughly 20 days and briefly transformed public parks and streets into shared game spaces.", highlights: ["The physical world became Pokémon’s newest interface.", "Researchers measured short-term increases in outdoor movement, though lasting health effects were mixed.", "Sun and Moon used Hawaii and regional forms to make adaptation part of Pokémon design."], source: "Pokémon GO launch record · Guinness World Records", sourceUrl: "https://www.guinnessworldrecords.com/news/2016/8/pokemon-go-catches-five-new-world-records-439327" },
  { id: "platform-ecosystem", year: "2017–2023", title: "From series to ecosystem", subtitle: "Switch, HOME, open worlds, and new heroes", image: "/art/1723.webp", caption: "Sprigatito · a new generation for games and animation", body: "The Switch era dissolved the boundary between handheld and console Pokémon. Let’s Go connected with mobile play; HOME preserved collections across games; Legends: Arceus reworked capture and exploration; and Scarlet and Violet made the core journey fully open-world.", highlights: ["Pokémon became a network of games and services rather than one isolated release at a time.", "Dedicated operations expanded across Asia, including India, Singapore, Shanghai, and Taiwan.", "In 2023 Liko and Roy inherited the anime from Ash and Pikachu after more than 25 years."], source: "The Pokémon Company · Official history and localization records", sourceUrl: "https://corporate.pokemon.co.jp/en/topics/detail/t-42/" },
  { id: "living-archive", year: "2024–2026", title: "A living archive", subtitle: "Digital cards, physical collecting, and thirty years", image: "/shop/binders/mew/ancient-mew.png", caption: "Ancient Mew · collecting continually turns Pokémon’s past into its present", body: "Pokémon’s current era connects physical collecting, TCG Pocket, competitive games, location-based play, animation, live destinations, and historical nostalgia. The past is no longer only remembered—it is continually rescanned, reissued, rediscovered, and reorganized.", highlights: ["TCG Pocket brought card opening and collecting into a mobile-first format in 2024.", "Legends: Z-A followed in 2025; PokéPark KANTO and Pokémon Champions arrived in 2026.", "At thirty, Pokémon operates as cultural infrastructure as much as a sequence of products."], source: "Pokémon 30 · Official anniversary record", sourceUrl: "https://30.pokemon.com/en-us" },
  { id: "the-ritual", year: "1996–present", title: "The ritual that endured", subtitle: "Discover, collect, exchange, belong", image: "/art/0547.webp", caption: "Bulbasaur · one creature, many generations of memory", body: "Pokémon survives because it keeps changing the doorway while protecting the same human ritual. The link cable, cards, television, worldwide launches, Pokémon GO, and persistent apps all answer the same desire: find something, care about it, and share that discovery with someone else.", highlights: ["The franchise was built collaboratively, not according to a perfect master plan.", "Every successful new medium preserved collection and social exchange.", "The archive is part of that history: fans have become active custodians of design memory."], source: "Pocket Archives synthesis · primary and scholarly sources", sourceUrl: "https://corporate.pokemon.co.jp/en/aboutus/figures/" },
];
...
export default function Home() {
  ...
  const [archiveSection, setArchiveSection] = useState<"history" | "alpha" | "sketches" | "references">("history");
  ...
  const [spriteEvolution, setSpriteEvolution] = useState<SpriteEvolutionManifest | null>(null);
  ...
  useEffect(() => {
    ...
    fetch("/data/sprite-evolution.json").then((response) => response.json()).then(setSpriteEvolution);
  ...
  const selectedShopItems = selectedGroup?.dex ? inventoryForPokemon(selectedGroup.dex).filter((item) => item.availabilityStatus === "available") : [];
  ...
  const original151 = useMemo(() => Array.from({ length: 151 }, (_, index) => {
    const dex = index + 1;
    return { dex, name: setteiDirectory.find((group) => group.dex === dex)?.name || `Pokémon #${String(dex).padStart(3, "0")}` };
  }), [setteiDirectory]);
  ...
  function openArchiveSection(section: "history" | "alpha" | "sketches" | "references") {
  ...
  return (
    <main>
      <header className="site-header">
        ...
        <nav aria-label="Primary navigation"><button className={view === "references" ? "active" : ""} onClick={() => openTopLevelPage("archive")}>Archives</button><a href="https://shop.pocketarchives.com/shop">Shop ↗</a></nav>
      ...
      <section className="collection" id="collection">
        <div className="section-heading"><div><p className="eyebrow"><span /> {view === "favorites" ? "Your collection" : "Pocket Archives"}</p><h2>{view === "favorites" ? "Saved for later." : "Archives."}</h2></div><p>{view === "favorites" ? "Every archive record you have favorited on this device, gathered in one place." : "A guided history of Pokémon design—from the earliest concepts to character sketches and production sheets."}</p></div>
        <div className="view-tabs" role="tablist" aria-label="Collection views">
          <button role="tab" aria-selected={view === "references"} className={view === "references" ? "active" : ""} onClick={openReferences}><span>01</span> Archives</button>
          <a className="shop-view-tab" href="https://shop.pocketarchives.com/shop"><span>02</span> Shop ↗</a>
        </div>

        {view === "references" && archiveSection === "history" ? <div className="archive-orientation"><span>Start here</span><p>Follow the timeline, then move into the surviving drawings and working production material.</p></div> : <div className="filter-panel">
          <label className="search-box"><span aria-hidden="true">⌕</span><input ref={searchRef} value={query} onChange={(event) => setQuery(event.target.value)} placeholder={view === "references" ? "Search Pokémon, prototype, pose, or sheet…" : "Search saved archive records…"} aria-label={view === "references" ? "Search the archives" : "Search saved archive records"} /><kbd>/</kbd></label>
          <p className="favorites-note">{view === "references" ? "Open any image to inspect it without leaving the archive." : "Your saved archive records live here on this device."}</p>
        </div>}

        {!(view === "references" && archiveSection === "history") && <div className="results-bar"><p>{view === "references" ? <><b>{archiveSection === "alpha" ? developmentResults.length.toLocaleString() : archiveSection === "sketches" ? designResults.length.toLocaleString() : referenceItems.length.toLocaleString()}</b> {archiveSection === "alpha" ? "early-design records" : archiveSection === "sketches" ? "character sketch groups" : "production sheets"}</> : <><b>{activeGroups.length.toLocaleString()}</b> saved records</>}</p><div className="results-controls">{view === "favorites" && <div className="display-toggle" role="group" aria-label="Display style"><button className={displayMode === "grid" ? "active" : ""} onClick={() => changeDisplay("grid")} aria-pressed={displayMode === "grid"}><span>▦</span> Grid</button><button className={displayMode === "list" ? "active" : ""} onClick={() => changeDisplay("list")} aria-pressed={displayMode === "list"}><span>☰</span> Names</button></div>}</div></div>}

        {view === "references" ? <div className="reference-library" id="archive-browser">
          <nav className="archive-index" aria-label="Archive sections"><button className={archiveSection === "history" ? "active" : ""} onClick={() => openArchiveSection("history")}><small>01</small><b>History</b><span>{museumRooms.length} chapters</span></button><button className={archiveSection === "alpha" ? "active" : ""} onClick={() => openArchiveSection("alpha")}><small>02</small><b>Early designs</b><span>{developmentResults.length} records</span></button><button className={archiveSection === "sketches" ? "active" : ""} onClick={() => openArchiveSection("sketches")}><small>03</small><b>Character sketches</b><span>{designResults.length} Pokémon</span></button><button className={archiveSection === "references" ? "active" : ""} onClick={() => openArchiveSection("references")}><small>04</small><b>Production sheets</b><span>{referenceItems.length} sheets</span></button></nav>
          {archiveSection === "history" && <section className="archive-history"><button className="museum-launch" onClick={() => setTourRoom(0)}><span><small>Guided chronological exhibition</small><b>The history of Pokémon</b><em>{museumRooms.length} chapters · Japan to the world · approximately 10 minutes</em></span><strong>Begin <i>→</i></strong></button><div className="archive-history-heading"><span>1965–present</span><h3>A world built over time.</h3><p>Move through the major moments in order. Each chapter connects the historical story to the surviving artwork and evidence.</p></div><div className="archive-timeline">{museumRooms.map((room, index) => <button key={room.id} onClick={() => setTourRoom(index)}><span className="archive-timeline-year">{room.year}</span><span className="archive-timeline-image"><img src={room.image} alt="" loading="lazy" /></span><span className="archive-timeline-copy"><small>Chapter {String(index + 1).padStart(2, "0")}</small><b>{room.title}</b><p>{room.subtitle}</p><em>Read chapter →</em></span></button>)}</div><div className="archive-research-strip"><div><small>Closer study</small><h3>How the first roster evolved</h3><p>Five concise design periods explain the shift from early kaiju-like creatures to a more connected world of types, families, and personalities.</p></div><div>{internalListPanels.map((panel, index) => <button key={panel.id} onClick={() => setSelectedPanel(panel)}><span>{String(index + 1).padStart(2, "0")}</span><b>{panel.title}</b></button>)}</div></div>{spriteEvolution && <section className="sprite-evolution" aria-labelledby="sprite-evolution-title"><header><div><span>1996–2016 · Interactive collection</span><h3 id="sprite-evolution-title">The original 151<br />through seven generations.</h3></div><p>Choose any of the original 151 and compare its front battle image from Red and Blue through Sun and Moon. See how each design changed as the games moved from small pixel sprites to 3D renders.</p></header><div className="sprite-picker"><button onClick={() => setSpriteDex((dex) => dex === 1 ? 151 : dex - 1)} aria-label="Previous Pokémon">←</button><label><span>Choose a Pokémon</span><select value={spriteDex} onChange={(event) => setSpriteDex(Number(event.target.value))}>{original151.map((pokemon) => <option value={pokemon.dex} key={pokemon.dex}>#{String(pokemon.dex).padStart(3, "0")} · {pokemon.name}</option>)}</select></label><button onClick={() => setSpriteDex((dex) => dex === 151 ? 1 : dex + 1)} aria-label="Next Pokémon">→</button></div><div className="sprite-subject"><span>#{String(spriteDex).padStart(3, "0")}</span><strong>{selectedSpritePokemon?.name}</strong><small>Seven generations · front battle view</small></div><div className="sprite-era-grid">{spriteEvolution.eras.map((era) => <figure key={era.key}><div><img src={`/sprites/${era.key}/${String(spriteDex).padStart(4, "0")}.png`} alt={`${selectedSpritePokemon?.name} in ${era.label}`} loading="lazy" /></div><figcaption><span>Gen {era.generation} · {era.year}</span><b>{era.label}</b></figcaption></figure>)}</div><footer><p><b>Collection record.</b> Compiled and numbered by Reddit user Stooban for the r/beadsprites community. Original game graphics belong to Nintendo, Game Freak, and Creatures.</p><span>1,057 locally preserved views</span></footer></section>}</section>}
          {archiveSection === "alpha" && (!!developmentResults.length ? <section className="development-archive"><div className="timeline-heading"><span>1990–1997 · Earliest material first</span><h3>Alpha &amp; beta archive</h3><p>Original concepts, extracted prototype assets, release-era Carddass illustrations, and research plates are labeled separately.</p></div><div className="thread-source-note"><p><b>Digital preservation source.</b> This room combines early Game Freak material, prototype research plates, and 52 unique images located through a Reddit/Imgur community archive. Original provenance is recorded separately and remains under research where uncertain.</p><span>Oldest to newest</span></div><div className="development-grid">{developmentResults.map((item) => <article className="development-card" key={item.id}><button onClick={() => setSelectedDevelopment(item)} aria-label={`Open ${item.title}`}><span className="development-image"><img src={item.src} alt={item.title} loading="lazy" /></span><span className="development-card-copy"><small>{item.year} · {item.kind}</small><strong>{item.title}</strong><em>{item.credit}</em></span></button></article>)}</div></section> : <div className="empty-state"><span>?</span><h3>No early material found</h3><p>Try a broader search.</p><button onClick={() => setQuery("")}>Clear search</button></div>)}
          ...
          {museumWing === "lobby" && <><button className="museum-launch" onClick={() => setTourRoom(0)}><span><small>Recommended first visit · Guided chronological exhibition</small><b>The full history of Pokémon</b><em>{museumRooms.length} rooms · Japan to the world · approximately 10 minutes</em></span><strong>Start tour <i>→</i></strong></button><div className="museum-room-intro"><span>After the main exhibition</span><h3>Step into the study rooms.</h3><p>The tour tells the full story. These two smaller galleries let you inspect how the first roster was designed and how incomplete historical evidence is interpreted.</p></div><div className="museum-room-choices"><button className="museum-room-choice periods" onClick={() => setMuseumWing("periods")}><small>Study room 02 · Internal archaeology</small><strong>Design Lab</strong><p>See how the original 190 internal slots developed across five broad design periods.</p><span>Enter room →</span></button><button className="museum-room-choice research" onClick={() => setMuseumWing("research")}><small>Study room 03 · Source criticism</small><strong>Evidence Desk</strong><p>Learn what actually survives—and where a confident claim becomes an informed theory.</p><span>Enter room →</span></button></div></>}
          {museumWing === "periods" && <section className="internal-list-wing museum-focused-wing"><button className="museum-wing-back" onClick={() => setMuseumWing("lobby")}>← Museum lobby</button><div className="museum-wing-heading"><span>Study room 02 · Internal archaeology</span><h3>Design Lab</h3><p>Read from Period 1 through Period 5. This is Helix Chamber’s research framework for the original Red &amp; Green roster—not a confirmed production timeline.</p></div><div className="museum-stat-strip"><div><b>190</b><span>internal slots</span></div><div><b>151</b><span>released Pokémon</span></div><div><b>39</b><span>unused slots</span></div><div><b>5</b><span>design periods</span></div></div><div className="internal-period-grid">{internalListPanels.map((panel, index) => <button key={panel.id} onClick={() => setSelectedPanel(panel)}><small>Period {String(index + 1).padStart(2, "0")}</small><b>{panel.title}</b><p>{panel.description}</p><span>Read period →</span></button>)}</div></section>}
          {museumWing === "research" && <section className="museum-research-wing museum-focused-wing"><button className="museum-wing-back" onClick={() => setMuseumWing("lobby")}>← Museum lobby</button><div className="museum-wing-heading"><span>Study room 03 · Source criticism</span><h3>Evidence Desk</h3><p>Start with note 01, or choose a question. These concise explanations separate surviving files, documented facts, community preservation, and informed interpretation.</p></div><div className="research-square-grid" aria-label="Local prototype research explanations">{helixResearchPanels.map((panel, index) => <button key={panel.id} onClick={() => setSelectedPanel(panel)}><small>{String(index + 1).padStart(2, "0")} · Evidence note</small><b>{panel.title}</b><span>Read note →</span></button>)}</div></section>}
      ...
      {selected && selectedGroup && <div className="modal" role="dialog" aria-modal="true" aria-label={`${selectedGroup.title} archive record`} onMouseDown={(event) => { if (event.currentTarget === event.target) setSelected(null); }}>
        ...
        <div className="modal-details"><p className="eyebrow"><span /> {selectedGroup.dex ? `Generation ${generationRoman[selectedGroup.generation]} · ${generationRegions[selectedGroup.generation]}` : selected.collection}</p><h2>{selectedGroup.title}</h2>{detailsLoading ? <p className="details-loading">Reading species record…</p> : details ? <><p className="pokemon-genus">{details.legendary ? "Legendary · " : details.mythical ? "Mythical · " : ""}{details.genus}</p><p className="dex-description">{details.description}</p><div className="type-row">{details.types.map((type) => <span className={`type type-${type}`} key={type}>{titleCase(type)}</span>)}</div><dl className="pokemon-facts"><div><dt>Height</dt><dd>{details.height} m</dd></div><div><dt>Weight</dt><dd>{details.weight} kg</dd></div><div><dt>Habitat</dt><dd>{details.habitat ? titleCase(details.habitat) : "Unknown"}</dd></div><div><dt>Artwork</dt><dd>{selectedGroup.items.length} in archive</dd></div></dl></> : selectedGroup.dex ? <p className="dex-description">Species information is temporarily unavailable.</p> : <p className="dex-description">This unnumbered artwork belongs to the {selected.collection} collection.</p>}
          ...
          <div className="modal-actions"><button onClick={() => toggleFavorite(selectedGroup.key)}>{favorites.has(selectedGroup.key) ? "♥ In favorites" : "♡ Add to favorites"}</button>{selectedRights && canDownload(selectedRights) && variantView !== "cards" && <a href={selected.src} download>Download art ↓</a>}</div><p className="key-hint">Use ← → for next Pokémon · Esc to close</p>
        </div>
      </div>}
      ...
      {selectedReference && <div className="reference-viewer" role="dialog" aria-modal="true" aria-label={`${selectedReference.group.name} reference sheet`} onMouseDown={(event) => { if (event.currentTarget === event.target) setSelectedReference(null); }}>
        ...
        <aside className="reference-viewer-details">
          ...
          <div className="reference-source"><span>Provenance</span><b>Original material · Anime production reference</b><p>Digital preservation source · {referenceProvenance(selectedReference.group.links[selectedReference.index].url).label}{referenceProvenance(selectedReference.group.links[selectedReference.index].url).archived ? " · preserved copy" : ` · ${referenceProvenance(selectedReference.group.links[selectedReference.index].url).host}`}<br />Creator · not identified · Rights · respective rights holder · Displayed for archival and research context</p></div>
      ...
      {selectedDevelopment && <div className="reference-viewer development-viewer" role="dialog" aria-modal="true" aria-label={`${selectedDevelopment.title} early development plate`} onMouseDown={(event) => { if (event.currentTarget === event.target) setSelectedDevelopment(null); }}>
        ...
        <aside className="reference-viewer-details">
          ...
          <div className="reference-source"><span>Provenance</span><b>Original material · {selectedDevelopment.credit}</b><p>Digital preservation source · {selectedDevelopment.sourceLabel}<br />Rights · respective rights holder · Status · displayed for archival and research context</p></div>
