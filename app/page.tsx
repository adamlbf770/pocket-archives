    ...
    <main>
      ...
      <section className="collection" id="collection">
        ...
        <div className="view-tabs" role="tablist" aria-label="Collection views">
          ...
          <button role="tab" aria-selected={view === "references"} className={view === "references" ? "active" : ""} onClick={() => { setView("references"); setFilter("all"); }}><span>03</span> References & sketches <b>{designResults.length + referenceResults.reduce((sum, group) => sum + group.links.length, 0)}</b></button>
        </div>
